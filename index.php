...
<body class="hold-transition login-page">
    ...
    <div id="layoutAuthentication">
        <div id="layoutAuthentication_content">
            <main>
                <div class="container">
                    <div class="row justify-content-center" style="margin:down 200;">
                        <div class="col-lg-5">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                <div class="card-header text-center">
                                    <img class="img-thumbnail" src="assets/img/SISE.png" width="100">
                                    <h3 class="font-weight-light my-4">Almacen W.D.A</h3>
                                </div>
                                <div class="card-body">
            ...
            <footer class="py-4 bg-light mt-auto">
                <div class="container-fluid">
                    <div class="d-flex align-items-center justify-content-between small">
                        <div class="text-muted">Prof. Alex Sullon<a target="_blank" rel="noopener noreferrer">Taller_Programacion_A</a> <?php echo date("Y"); ?></div>
                        <div>
                            <a href="https://www.facebook.com/wili.montesramirez/">Grupo1</a>
                        </div>
                    </div>
                </div>
            </footer>
