                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div>
                                ...
                                <label>Nombre</label>
                                <input type="text" name="nom_cliente" id="nom_cliente" class="form-control" placeholder="Ingrese nombre del trabajador" required>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            <label><i class="fas fa-user"></i> Almacenero</label>
                            <p style="font-size: 16px;  color: red;"><?php echo $_SESSION['nombre']; ?></p>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="card">
